...
SWE_EPHE_PATH=public/swisseph-master/ephe ASTRO_ENGINE_PORT=5005 node astro-engine/server.js
```

| Variable | Description | Default |
| --- | --- | --- |
| `SWE_EPHE_PATH` | Directory containing `.se1/.se2` files | `public/swisseph-master/ephe` |
