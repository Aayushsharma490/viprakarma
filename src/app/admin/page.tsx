            ...
            <Card className="classical-card p-4 md:p-6">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 p-3 md:p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                  ...
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">Platform Growth</p>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 p-3 md:p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                  ...
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">Expert Astrologers</p>
                    <p className="text-xs md:text-sm text-muted-foreground">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 p-3 md:p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                  ...
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">Total Revenue</p>
                    <p className="text-xs md:text-sm text-muted-foreground">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 md:gap-4 p-3 md:p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                  ...
                  <div>
                    <p className="font-semibold text-foreground text-sm md:text-base">Total Bookings</p>
                    <p className="text-xs md:text-sm text-muted-foreground">
            ...
            <Card className="classical-card p-4 md:p-6">
              ...
              <div className="space-y-3 md:space-y-4">
                {recentBookings.length === 0 ? (
                  <p className="text-center text-muted-foreground py-6 md:py-8 text-sm md:text-base">No bookings found</p>
                ) : (
