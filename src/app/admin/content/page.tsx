...
import { Plus, Edit, Save, Loader2, FileText, MessageSquare, HelpCircle } from 'lucide-react';
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className={`px-2 py-1 text-xs rounded ${
                                item.isPublished ? 'bg-green-500/20 text-green-500' : 'bg-gray-500/20 text-gray-500'
                              }`}>
