            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="classical-card p-6 classical-hover">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Your life's journey</p>
                    </div>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">{numerologyData.insights.lifePathMeaning}</p>
                </Card>
                ...
                <Card className="classical-card p-6 classical-hover">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Your core motivation</p>
                    </div>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">
                    Your driver number represents your primary driving force and how you approach life's challenges. 
                    It shapes your natural instincts and immediate reactions.
                  </p>
                </Card>
                ...
                <Card className="classical-card p-6 classical-hover">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-pink-900">Conductor Number</h3>
                      <p className="text-sm text-gray-600">Your guiding energy</p>
                    </div>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">
                    Your conductor number guides and supports your driver number. It represents 
                    the underlying energy that helps you navigate through life's path.
                  </p>
                </Card>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="classical-card p-6 classical-hover">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm">{numerologyData.insights.destinyMeaning}</p>
                </Card>
                ...
                <Card className="classical-card p-6 classical-hover">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm">{numerologyData.insights.soulUrgeMeaning}</p>
                </Card>
                ...
                <Card className="classical-card p-6 classical-hover">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">How others see you</p>
                    </div>
                  </div>
                  <p className="text-gray-700 leading-relaxed text-sm">{numerologyData.insights.personalityMeaning}</p>
                </Card>
              </div>
              ...
              <Card className="classical-card p-8 bg-gradient-to-br from-amber-50 to-amber-100 classical-shadow">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  Driver Number <strong className="text-amber-900">{numerologyData.driverNumber}</strong> and 
                  Conductor Number <strong className="text-amber-900">{numerologyData.conductorNumber}</strong> creates 
                  your unique energy signature. Your Destiny <strong className="text-amber-900">{numerologyData.destiny}</strong> guides 
                  your ultimate purpose, while Soul Urge <strong className="text-amber-900">{numerologyData.soulUrge}</strong> drives 
                ...
                <div className="bg-amber-600 text-white rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-50">
                      ...
                      and detailed guidance tailored to your unique numbers.
                    </p>
                  </div>
                </div>
              </Card>
