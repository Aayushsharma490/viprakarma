          ...
          >
            <Card className="glass-effect p-8 md:p-12">
              ...
              <p className="text-lg text-muted-foreground text-center leading-relaxed mb-4">
                At Kundali Platform, we believe that understanding the cosmic forces that shape our lives 
                can lead to better decisions, deeper self-awareness, and a more fulfilling existence. 
                Our mission is to make authentic Vedic astrology accessible to everyone through 
          ...
          >
            <Card className="glass-effect p-8 md:p-12">
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>
                  Kundali Platform was born from a deep passion for Vedic astrology and a vision to 
