...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: "/talk-to-astrologer", label: "Talk to Astrologer" },
  ...
  return (
    <>
      ...
      <Link href="/talk-to-astrologer" legacyBehavior>
        <a style={{ position: "fixed", bottom: "1.5rem", left: "1.5rem", zIndex: 50 }}>
          <Button
          ...
          >
            ...
            <span className={"block " + (language === 'en' ? 'whitespace-normal leading-tight' : 'whitespace-nowrap')}
              style={language === 'en' ? { lineHeight: '1.1', textAlign: 'left' } : {}}>
              {language === 'en' ? (
                <>
                  Talk to<br />Astrologer
                </>
              ) : (
                'Talk to Astrologer'
              )}
