    ...
    <footer className="glass-effect border-t border-border/50 mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-cosmic">Kundali Platform</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Discover your cosmic blueprint with personalized astrology insights and expert guidance.
            </p>
          </div>
        ...
        <div className="border-t border-border/50 mt-8 pt-6 text-center">
          <p className="text-muted-foreground text-sm">
            © {currentYear} Kundali Platform. All rights reserved. Made with ✨ for cosmic seekers.
          </p>
        </div>
      </div>
    </footer>
