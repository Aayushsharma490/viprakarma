...
export default function PaymentModal({
  ...
  const handlePaymentDetailsSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Payment details submitted successfully! Admin will verify your payment and activate your service.', {
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="p-4 bg-white border-2 border-amber-600 rounded-lg shadow-lg">
                  <Image src="/qr.jpg" alt="Payment QR Code" width={200} height={200} />
                </div>
