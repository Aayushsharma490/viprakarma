...
export default function KundaliChart({ planets, houses, ascendant }: KundaliChartProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 min-h-screen bg-[#3A1F00]">
      <h2 className="text-yellow-400 text-3xl font-bold mb-8 tracking-wide">Kundali</h2>
          ...
          <div className="absolute inset-0">
            ...
            <svg width="100%" height="100%" viewBox="0 0 500 500" className="absolute inset-0">
              <polygon
                ...
                strokeWidth="3"
              />
              <line x1="0" y1="0" x2="500" y2="500" stroke="#fff" strokeWidth="2" />
              <line x1="500" y1="0" x2="0" y2="500" stroke="#fff" strokeWidth="2" />
            </svg>
              ...
              return (
                ...
                >
                  <div className="text-xs font-bold mb-1 text-white">
                    {houseNumber}{' '}
                    {houses && houses[houseNumber - 1] && zodiacSigns[houses[houseNumber - 1].rashi]}
                  </div>
