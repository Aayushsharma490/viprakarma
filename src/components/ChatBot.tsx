...
export default function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: '🙏 Namaste! I\'m your AI Astrology assistant at Astro Genesis. Ask me about daily horoscope (Rashi Pal), Kundali, numerology, palmistry, planets, yogas, nakshatras, remedies, and more! How can I guide you today? ✨',
    },
  ]);
